...
export class AllemployeesComponent implements OnInit, OnDestroy {
  columnDefinitions = [
    ...
    { def: 'birthDate', label: 'Birth Date', type: 'date', visible: false },
    ...
    { def: 'degree', label: 'Degree', type: 'text', visible: false },
    ...
    { def: 'salary', label: 'Salary', type: 'number', visible: false },
    {
      def: 'lastPromotionDate',
  ...
  exportExcel() {
    const exportData = this.dataSource.filteredData.map((x) => ({
      ...
      Salary: x.salary,
      'Last Promotion Date':
        formatDate(new Date(x.lastPromotionDate), 'yyyy-MM-dd', 'en') || '',
      'Employee Status': x.employeeStatus,
