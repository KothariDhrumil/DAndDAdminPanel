...
public sealed class GetConfirmedPurchasesQueryHandler(IRetailDbContext db) 
    : IQueryHandler<GetConfirmedPurchasesQuery, List<PurchaseResponse>>
{
    public async Task<Result<List<PurchaseResponse>>> Handle(GetConfirmedPurchasesQuery query, CancellationToken ct)
    {
